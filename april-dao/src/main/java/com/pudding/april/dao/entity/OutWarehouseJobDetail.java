...
public class OutWarehouseJobDetail implements Serializable {
    ...
    public Integer getOutJobId() {
        return outJobId;
    }

    public void setOutJobId(Integer outJobId) {
    ...
    public BigDecimal getRealJobQty() {
        return realJobQty;
    }

    public void setRealJobQty(BigDecimal realJobQty) {
        this.realJobQty = realJobQty;
    }
