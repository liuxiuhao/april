...
public class InventoryOrderDetail implements Serializable {
    ...
    public String getInventoryOrderCode() {
        return inventoryOrderCode;
    }

    public void setInventoryOrderCode(String inventoryOrderCode) {
        this.inventoryOrderCode = inventoryOrderCode;
    }
    ...
    public String toString() {
        ...
        "id=" + id +
        ", inventoryOrderCode=" + inventoryOrderCode +
        ", stockId=" + stockId +
        ", skuCode=" + skuCode +
        ", skuName=" + skuName +
        ", batchNo=" + batchNo +
