...
public class LogisticsOrderDetail implements Serializable {
    ...
    public void setOutOrderDetailId(Integer outOrderDetailId) {
    ...
    public Integer getCarrierQty() {
        return carrierQty;
    }

    public void setCarrierQty(Integer carrierQty) {
